---
title: 'Theme Toggle'
description: 'Dark Light switch toggle with in / out animation'
image: '/component-images/theme-toggle.png'
order: 4
---

import ThemeToggle from '@ui-components/theme-toggle/theme-toggle.astro';
...
.theme-toggle__icon-active {
	animation: icon-active 0.5s ease-in forwards;
}

.theme-toggle__icon-inactive {
	animation: icon-inactive 0.5s ease-in forwards;
}
